...
final class CaptureFrameEnqueueAggregator {
  ...
  private let queue = DispatchQueue(label: "com.open_vitals.swift.capture-frame-enqueue", qos: .utility)
...
final class CaptureFrameWriteQueue: @unchecked Sendable {
  private let writeQueue = DispatchQueue(label: "com.open_vitals.swift.capture-frame-writes", qos: .utility)
      ...
      do {
        let report = try rust.request(
          ...
          args: [
            ...
            "parser_version": "open-vitals/live-notification",
