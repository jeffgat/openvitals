...
struct OvernightGuardHistoricalOrderEvidence {
  ...
  var jsonObject: [String: Any] {
    [
      "schema": "open_vitals.overnight.historical_transfer_order.v1",
...
final class HealthPacketCaptureFamilyAggregator {
  ...
  private let queue = DispatchQueue(label: "com.open_vitals.swift.health-packet-family-aggregator", qos: .utility)
