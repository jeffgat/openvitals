...
final class OvernightRawNotificationSpool: @unchecked Sendable {
  ...
  private let queue = DispatchQueue(label: "com.open_vitals.swift.overnight-raw-spool", qos: .utility)
  ...
  func append(event: OpenVitalsNotificationEvent, activeDeviceName: String, connectionState: String) -> OvernightRawSpoolSnapshot {
    queue.sync {
      ...
      var row: [String: Any] = [
        "schema": "open_vitals.overnight.raw_notification.v2",
  ...
  func appendHistoricalRangeTelemetry(_ telemetry: OpenVitalsHistoricalRangeTelemetry) -> OvernightRawSpoolSnapshot {
    queue.sync {
      ...
      let row: [String: Any] = [
        "schema": "open_vitals.overnight.historical_range_poll.v1",
        "session_id": sessionID,
  ...
  func appendCommandWrite(_ event: OpenVitalsCommandWriteEvent, activeDeviceName: String, connectionState: String) -> OvernightRawSpoolSnapshot {
    queue.sync {
      ...
      let row: [String: Any] = [
        "schema": "open_vitals.overnight.command_write.v1",
        "session_id": sessionID,
  ...
  func appendEventLog(_ message: OpenVitalsMessage) -> OvernightRawSpoolSnapshot {
    queue.sync {
      ...
      let row: [String: Any] = [
        "schema": "open_vitals.overnight.event_log.v1",
        "session_id": sessionID,
  ...
  private func writeManifestLocked(status: String) throws {
    ...
    var manifest: [String: Any] = [
      "schema": "open_vitals.overnight.manifest.v1",
      "session_id": sessionID,
      "status": status,
  ...
  private func writeCrashMarkerLocked(timestamp: String, statusLines: [String]) {
    ...
    let marker: [String: Any] = [
      "schema": "open_vitals.overnight.crash_marker.v1",
      "session_id": sessionID ?? "none",
      "active": active,
  ...
  private func writeCheckpointLocked(
    ...
    var checkpoint: [String: Any] = [
      "schema": "open_vitals.overnight.checkpoint.v1",
      "session_id": sessionID,
