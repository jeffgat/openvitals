...
extension OpenVitalsAppModel {
  ...
  func parseNotificationFrames(_ frames: [NotificationFrame], event: OpenVitalsNotificationEvent) {
  ...
  func notificationParseContext(for event: OpenVitalsNotificationEvent) -> NotificationParseContext {
  ...
  func handleParsedNotificationFrame(_ interpretation: NotificationFrameInterpretation, event: OpenVitalsNotificationEvent) {
