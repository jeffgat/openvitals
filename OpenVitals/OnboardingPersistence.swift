...
enum OnboardingStorage {
  static let onboardingComplete = "open_vitals.swift.onboardingComplete"
  static let onboardingRedoRequested = "open_vitals.swift.onboardingRedoRequested"
  static let firstName = "open_vitals.swift.profile.firstName"
  static let dateOfBirth = "open_vitals.swift.profile.dateOfBirth"
  static let unitSystem = "open_vitals.swift.profile.unitSystem"
  static let heightInput = "open_vitals.swift.profile.heightInput"
  static let heightFeetInput = "open_vitals.swift.profile.heightFeetInput"
  static let heightInchesInput = "open_vitals.swift.profile.heightInchesInput"
  static let weightInput = "open_vitals.swift.profile.weightInput"
  static let gender = "open_vitals.swift.profile.gender"
  static let heightMm = "open_vitals.swift.profile.heightMm"
  static let weightGrams = "open_vitals.swift.profile.weightGrams"
  static let createdAtUnixMs = "open_vitals.swift.profile.createdAtUnixMs"
  static let timezoneID = "open_vitals.swift.profile.timezoneID"
  static let healthKitPermissionHandled = "open_vitals.swift.permissions.healthKitHandled"
  static let locationPermissionHandled = "open_vitals.swift.permissions.locationHandled"
  static let notificationPermissionHandled = "open_vitals.swift.permissions.notificationHandled"
  static let persistedState = "open_vitals.swift.onboarding.persistedState"
}
...
enum OnboardingProfilePersistence {
  private static let keychainService = "com.open_vitals.swift.onboarding"
