...
final class PacketMonitorModel: ObservableObject {
  ...
  @Published var latestWhoopEventStatus = "No device events"
  @Published var latestSkinTemperatureCandidateStatus = "No skin temperature events"
  @Published var latestWhoopDataPacketStatus = "No device data packets"
  ...
  @Published var liveDeviceDataSummary = "No live device data points"
