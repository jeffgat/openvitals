...
extension HealthDataStore {
  func stressAlgorithmSummary(
    ...
    return StressAlgorithmSummary(
      ...
      source: .localEstimate("open_vitals.stress.hr_proxy.v1 | confidence=\(confidenceText) | \(inputSummary)"),
  ...
  func energyBankAlgorithmSummary(
    ...
    return EnergyBankAlgorithmSummary(
      ...
      source: .localEstimate("open_vitals.energy_bank.v1 | confidence=\(confidenceText) | \(inputSummary)"),
      freshness: stress.freshness,
