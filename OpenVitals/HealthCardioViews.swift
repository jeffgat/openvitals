  ...
  var body: some View {
    VStack(alignment: .leading, spacing: 24) {
      ...
      VStack(alignment: .center, spacing: 12) {
        ...
        Text("OpenVitals uses historical activity and heart-rate data to calibrate Cardio Load. Consistent workout logging improves the dynamic range, and up to 6 weeks of data gives the most reliable status.")
          .font(.callout.weight(.semibold))
          .lineSpacing(5)
          .foregroundStyle(.white.opacity(0.58))
          .multilineTextAlignment(.center)
