...
final class OpenVitalsMessageStore: ObservableObject {
  @Published private(set) var messages: [OpenVitalsMessage] = []

  private let maximumMessages: Int
  private let flushInterval: TimeInterval
  private var pendingMessages: [OpenVitalsMessage] = []
  ...
  func enqueue(_ message: OpenVitalsMessage) {
