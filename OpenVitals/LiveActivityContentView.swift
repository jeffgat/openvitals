...
struct LiveActivityContentView: View {
  ...
  @AppStorage("open_vitals.swift.activity.lockHintSeen") private var lockHintSeen = false
  @AppStorage("open_vitals.swift.activity.recentWorkouts") private var recentWorkoutRawValues = ""
