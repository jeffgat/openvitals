...
extension OpenVitalsBLEClient {
  ...
  func enqueueDisplayedMessage(_ message: OpenVitalsMessage) {
  ...
  func appendDiagnosticLog(_ message: OpenVitalsMessage) {
  ...
  static func recordDiagnosticLogSetupWarning(_ warning: String) {
    ...
    Logger(subsystem: "com.open_vitals.swift", category: "ble")
  ...
  func writeConsoleDiagnosticLog(_ message: OpenVitalsMessage) {
  ...
  func shouldDisplayMessage(_ message: OpenVitalsMessage) -> Bool {
  ...
  func shouldWriteOSLog(_ message: OpenVitalsMessage) -> Bool {
    if message.level == .warn || message.level == .error {
      return true
    }
    return !isHighVolumeDiagnostic(message)
  ...
  func isHighVolumeDiagnostic(_ message: OpenVitalsMessage) -> Bool {
  ...
  func shouldPersistDiagnosticLog(_ message: OpenVitalsMessage) -> Bool {
    if message.source == "ble.perf" {
      return true
    }
