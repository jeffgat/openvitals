...
enum CodexLocalToolContext {
  static func build(healthStore: HealthDataStore, appModel: OpenVitalsAppModel) -> [String: Any] {
    [
  ...
  private static func getCaptureSessions(appModel: OpenVitalsAppModel) -> [String: Any] {
    [
  ...
  private static func getRawSessionData(appModel: OpenVitalsAppModel) -> [String: Any] {
    [
  ...
  private static func devicePayload(_ ble: OpenVitalsBLEClient) -> [String: Any] {
    [
