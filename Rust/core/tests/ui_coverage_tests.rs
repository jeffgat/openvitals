...
use open_vitals_core::ui_coverage::{
...
fn deferred_surfaces_are_reported_as_review_debt_without_becoming_missing() {
    ...
    let input = UiCoverageAuditInput {
        schema: "open_vitals.ui-coverage-audit.v1".to_string(),
        ...
        coverage: UiCoverageRules {
            navigation: vec![NavigationCoverageRule {
                ...
                open_vitals_area: "Activity".to_string(),
                target_level: None,
            ...
            layouts: vec![LayoutCoverageRule {
                ...
                status: UiCoverageStatus::Defer,
                open_vitals_area: "Content".to_string(),
                target_level: None,
            ...
            ui_resources: vec![UiResourceCoverageRule {
                ...
                resource: None,
                status: UiCoverageStatus::Defer,
                open_vitals_area: "Coverage Review".to_string(),
                target_level: None,
        ...
        coverage: UiCoverageRules {
            navigation: vec![
                NavigationCoverageRule {
                    ...
                    open_vitals_area: "Today".to_string(),
                ...
                NavigationCoverageRule {
                    ...
                    open_vitals_area: "Out of scope".to_string(),
                    target_level: None,
                    reason: Some(
                        "Social/community features are not part of OpenVitals MVP.".to_string(),
                    ),
                },
            ],
            layouts: vec![
                LayoutCoverageRule {
                    ...
                    open_vitals_area: "Screens".to_string(),
                ...
                LayoutCoverageRule {
                    ...
                    status: UiCoverageStatus::ApproximateLocally,
                    open_vitals_area: "Navigation shell".to_string(),
                    target_level: Some("component_inventory".to_string()),
                    reason: None,
                },
            ],
            ui_resources: vec![UiResourceCoverageRule {
                ...
                resource: None,
                status: UiCoverageStatus::ApproximateLocally,
                open_vitals_area: "Resource inventory".to_string(),
            ...
            source_classes: vec![SourceClassCoverageRule {
                ...
                module: None,
                status: UiCoverageStatus::ApproximateLocally,
                open_vitals_area: "Screen inventory".to_string(),
                target_level: Some("component_inventory".to_string()),
                reason: None,
            }],
        },
