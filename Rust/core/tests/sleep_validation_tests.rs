use open_vitals_core::{
    algorithm_compare::compare_sleep_v1_open_vitals_to_reference,
    ...
    store::{OpenVitalsStore, SleepCorrectionLabelInput},
};
...
fn sleep_v1_release_gate_validation_passes_only_when_all_evidence_reports_pass() {
    ...
    let input = SleepV1ReleaseGateInput {
        ...
        benchmark_comparisons: vec![
            compare_sleep_v1_open_vitals_to_reference(&sleep_v1_quality_gate_input()).unwrap(),
        ],
    ...
    assert_eq!(benchmark_acceptance["open_vitals_output_ready"], true);
    ...
    assert_eq!(
        report
            ...
            .and_then(serde_json::Value::as_str),
        Some(open_vitals_core::historical_sync::HISTORICAL_SYNC_PHYSICAL_REPORT_INTEGRITY_POLICY)
    );
    assert_eq!(
        report
            .provenance
    ...
    assert_eq!(
        report
            ...
            .and_then(|policies| policies.get("sleep-v1-benchmark.json"))
            .and_then(serde_json::Value::as_str),
        Some(open_vitals_core::algorithm_compare::SLEEP_V1_BENCHMARK_COMPARISON_POLICY)
    );
    ...
    forged_window.next_actions.push(
        open_vitals_core::sleep_validation::SleepWindowLabelValidationNextAction {
    ...
    forged_stability.next_actions.push(
        open_vitals_core::sleep_validation::SleepV1ExplanationStabilityNextAction {
    ...
    forged_benchmark.open_vitals_algorithm_id = "open_vitals.sleep.v0".to_string();
    ...
    forged_benchmark.acceptance_summary = Some(serde_json::json!({
        ...
        "open_vitals_output_ready": true,
        "reference_output_ready": true,
        "shared_fields_ready": true,
        "open_vitals_algorithm_id": "open_vitals.sleep.v1",
        "open_vitals_algorithm_version": "0.1.0",
        ...
        "open_vitals_quality_flag_count": 0,
    ...
    forged_benchmark.next_actions.push(
        open_vitals_core::algorithm_compare::AlgorithmComparisonNextAction {
    ...
    forged_benchmark.data_coverage = Some(serde_json::json!({
        "open_vitals_output_data_coverage_fraction": 1.5,
    }));
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["status_report"]
            .as_object_mut()
            .unwrap()
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["components"][0]["name"] = serde_json::json!("sleep need fulfillment");
        let component_provenance = open_vitals_output["component_provenance"]
            .as_object_mut()
            .unwrap();
    ...
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        ...
        open_vitals_output["component_provenance"]
            .as_object_mut()
            .unwrap()
            .insert(
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["component_provenance"]["continuity"]["policy"] =
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["component_provenance"]["sleep_architecture"]["inputs"]
            .as_object_mut()
            .unwrap()
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["component_provenance"]["data_confidence"]["policy"] =
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["component_provenance"]["data_confidence"]["inputs"]
            .as_object_mut()
            .unwrap()
    ...
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        ...
        let provenance = open_vitals_output["component_provenance"]
            .as_object_mut()
            .unwrap();
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["status_report"]["nights_until_training"] = serde_json::json!(99);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["status_report"]["excluded_sleep_nights"] = serde_json::json!(-1);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["model_status"] = serde_json::json!("training");
        open_vitals_output["model_status_label"] = serde_json::json!("Training");
        open_vitals_output["model_status_reason"] =
            serde_json::json!("OpenVitals is training a personal sleep model.");
        open_vitals_output["status_report"]["status"] = serde_json::json!("training");
        open_vitals_output["status_report"]["status_label"] = serde_json::json!("Training");
        open_vitals_output["status_report"]["status_reason"] =
            serde_json::json!("OpenVitals is training a personal sleep model.");
        open_vitals_output["status_report"]["calibration_label_count"] = serde_json::json!(14);
        open_vitals_output["status_report"]["nights_until_training"] = serde_json::json!(0);
        open_vitals_output["status_report"]["next_actions"] =
            serde_json::json!(["Collect 4 more OpenVitals packet-derived sleep nights."]);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["provenance"]["score_policy"] = serde_json::json!("hand-edited-policy");
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["component_provenance"]["sleep_need_fulfillment"]["inputs"] =
            serde_json::json!({});
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["components"][0]["contribution"] = serde_json::json!(999.0);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["score_0_to_100"] = serde_json::json!(99.0);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["stage_minutes"]["awake"] = serde_json::json!(999.0);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["model_status"] = serde_json::json!("learning");
        open_vitals_output["model_status_label"] = serde_json::json!("Learning");
        open_vitals_output["model_status_reason"] =
            serde_json::json!("3 valid sleep nights collected; 4 more for baseline.");
        open_vitals_output["status_report"]["status"] = serde_json::json!("learning");
        open_vitals_output["status_report"]["status_label"] = serde_json::json!("Learning");
        open_vitals_output["status_report"]["status_reason"] =
            serde_json::json!("3 valid sleep nights collected; 4 more for baseline.");
        open_vitals_output["status_report"]["report_state"] = serde_json::json!("provisional");
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["status_report"]["quality_flags"] =
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["status_report"]["valid_sleep_nights"] =
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["quality_flags"] = serde_json::json!(["sleep_architecture_unavailable"]);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["provenance"] = serde_json::json!({});
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["components"] = serde_json::json!([
            {
                "name": "only_component",
                "value": 420.0,
                "unit": "minutes",
        ...
        open_vitals_output["component_provenance"] = serde_json::json!({
            "only_component": {
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["components"][0]["name"] = serde_json::json!("");
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["status_report"]["report_state"] = serde_json::json!("final");
        open_vitals_output["status_report"]["can_show_final_score"] = serde_json::json!(false);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["status_report"]["valid_sleep_nights"] = serde_json::json!(999);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["sleep_duration_minutes"] = serde_json::json!(999.0);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["confidence_0_to_1"] = serde_json::json!(1.5);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["stage_segment_confidence_0_to_1"] = serde_json::json!(1.5);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["stage_minutes"]["deep"] = serde_json::json!(999.0);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["stage_minutes"]["unknown"] = serde_json::json!(0.0);
    }
    forged_benchmark.pass = true;
    forged_input.benchmark_comparisons = vec![forged_benchmark];
    ...
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        open_vitals_output["previous_night_comparison"] = serde_json::json!({
            "night_id": "",
    ...
    if let Some(open_vitals_output) = forged_benchmark.open_vitals_output.as_mut() {
        ...
        open_vitals_output["provenance"]["previous_night_comparison"] = serde_json::json!({
    ...
    let mut forged_input = input.clone();
    let mut forged_benchmark = forged_input.benchmark_comparisons.remove(0);
    forged_benchmark.provenance["open_vitals_comparable_inputs"]["disturbance_count"] =
...
fn sleep_v1_release_gate_cli_composes_individual_evidence_reports() {
    ...
    assert_eq!(
        ...
        "open_vitals.historical-sync-physical-validation-report.v1"
    );
    assert_eq!(
    ...
    assert!(
        report
            ...
            .any(|file| file.filename == "sleep-v1-release-gate.json"
                && file.schema.as_deref() == Some("open_vitals.sleep-v1-release-gate-report.v1"))
    );
    assert!(
        report
            .required_files
...
fn sleep_v1_evidence_folder_validation_rejects_unexpected_report_generator() {
    ...
    assert_eq!(
        ...
        Some("open_vitals.algorithm_compare")
    );
    assert_eq!(
...
fn sleep_v1_evidence_folder_validation_rejects_benchmark_missing_quality_flag_arrays() {
    ...
    benchmark_report
        .as_object_mut()
        .unwrap()
        .remove("open_vitals_quality_flags");
    benchmark_report
        .as_object_mut()
        .unwrap()
    ...
    assert_eq!(report.passing_required_file_count, 5);
    assert!(report.issues.contains(
        &"passing_required_file_missing_quality_flags:sleep-v1-benchmark.json:open_vitals_quality_flags"
            .to_string()
    ));
    assert!(report.issues.contains(
    ...
    assert!(report.next_actions.iter().any(|action| {
        action.scope == "sleep_v1.evidence_folder.reports"
            && action
                .reason
                .contains("sleep-v1-benchmark.json:open_vitals_quality_flags")
            && action
                .action
                .contains("explicit empty open_vitals_quality_flags list")
    }));
}
...
fn sleep_v1_evidence_folder_validation_rejects_passing_report_with_quality_flags() {
    ...
    assert!(
        report.issues.contains(
            &"passing_required_file_has_quality_flags:sleep-v1-benchmark.json:open_vitals_quality_flags"
                .to_string()
        )
    );
    let benchmark = report
...
fn sleep_v1_evidence_folder_validation_detects_benchmark_embedded_output_drift() {
    ...
    let mut benchmark_report: serde_json::Value =
        serde_json::from_str(&fs::read_to_string(&benchmark_path).unwrap()).unwrap();
    benchmark_report["open_vitals_output"]["provenance"]["hand_edited"] = serde_json::json!(true);
    write_json(&benchmark_path, &benchmark_report);
...
fn sleep_v1_evidence_folder_validation_rejects_stale_benchmark_contract_file() {
    ...
    let mut benchmark_report: serde_json::Value =
        serde_json::from_str(&fs::read_to_string(&benchmark_path).unwrap()).unwrap();
    benchmark_report["open_vitals_output"]["components"]
        .as_array_mut()
        .unwrap()
        .push(serde_json::json!({
            "name": "legacy_extra_component",
    ...
    benchmark_report["open_vitals_output"]["component_provenance"]
        .as_object_mut()
        .unwrap()
        .insert(
            "legacy_extra_component".to_string(),
...
fn sleep_v1_evidence_folder_validation_detects_sleep_window_store_drift() {
    let tempdir = tempfile::tempdir().unwrap();
    write_passing_sleep_v1_evidence_folder(tempdir.path());
    let store = OpenVitalsStore::open(&tempdir.path().join("sleep-window-store.sqlite")).unwrap();
    insert_sleep_window_label(
        &store,
...
fn write_passing_sleep_v1_evidence_folder(evidence_dir: &std::path::Path) {
    ...
    let store = OpenVitalsStore::open(&sleep_window_store_path).unwrap();
    seed_sleep_window_motion(&store);
    for (index, sleep_id) in [
        "packet-derived-sleep-2026-05-27",
        "packet-derived-sleep-2026-05-28",
    ...
    let window_input = SleepWindowLabelValidationEvidenceInput {
        schema: "open_vitals.sleep-window-label-validation-input.v1".to_string(),
    ...
    .unwrap();
    let benchmark_report = compare_sleep_v1_open_vitals_to_reference(&sleep_v1_input).unwrap();
...
fn seed_sleep_window_motion(store: &OpenVitalsStore) {
...
fn seed_sleep_window_heart_rate(store: &OpenVitalsStore) {
...
fn seed_release_gate_sleep_stage_labels(store: &OpenVitalsStore) {
    insert_sleep_stage_label(
        store,
...
fn physical_validation_input() -> HistoricalSyncPhysicalValidationInput {
    HistoricalSyncPhysicalValidationInput {
        schema: "open_vitals.historical-sync-physical-validation.v1".to_string(),
