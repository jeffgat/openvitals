...
fn assert_packet_derived_plan_report(
    ...
    assert_eq!(
        report.schema,
        open_vitals_core::activity_candidates::ACTIVITY_SESSION_PACKET_DERIVED_METRIC_PLAN_REPORT_SCHEMA
    );
    assert_eq!(
        report.generated_by,
        open_vitals_core::activity_candidates::ACTIVITY_SESSION_PACKET_DERIVED_METRIC_PLAN_GENERATED_BY
    );
