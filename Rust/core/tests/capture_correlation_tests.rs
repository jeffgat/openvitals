...
fn correlation_report_promotes_distinct_owned_history_and_motion_evidence() {
    ...
    assert!(report.observations.iter().any(|observation| {
        observation.evidence_id == "synthetic.open_vitals.v5.temperature_event"
...
fn owned_sources_for(
    report: &open_vitals_core::capture_correlation::CaptureCorrelationReport,
...
fn owned_sanitized_capture_can_satisfy_metric_promotion_gate() {
    ...
    fs::write(
        ...
        format!(
            r#"{{
  "schema": "open_vitals.captured-frame-batch.v1",
  "frames": [
    {{
  ...
  "app_version": "open-vitals-fixture",
  "schema": "open_vitals.captured-frame-batch.v1",
