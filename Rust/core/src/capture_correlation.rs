...
use crate::{
    ...
    store::{DecodedFrameRow, OpenVitalsStore, RawEvidenceRow},
};

pub const CAPTURE_CORRELATION_REPORT_SCHEMA: &str = "open_vitals.capture-correlation-report.v1";
...
pub fn run_capture_correlation(
    ...
    CaptureCorrelationReport {
        ...
        generated_by: "open-vitals-capture-correlation".to_string(),
...
pub fn run_capture_correlation_for_store(
    ...
    options: CaptureCorrelationOptions,
) -> OpenVitalsResult<CaptureCorrelationReport> {
