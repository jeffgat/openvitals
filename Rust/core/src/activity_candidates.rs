...
pub const ACTIVITY_CANDIDATE_CLASSIFIER_INPUT_SCHEMA: &str =
    "open_vitals.activity-candidate-classifier-input.v1";
pub const ACTIVITY_CANDIDATE_CLASSIFIER_REPORT_SCHEMA: &str =
    "open_vitals.activity-candidate-classifier-report.v1";
...
pub const ACTIVITY_CANDIDATE_GENERATED_BY: &str = "open-vitals-activity-candidate-classifier";
pub const ACTIVITY_SESSION_PACKET_DERIVED_METRIC_PLAN_REPORT_SCHEMA: &str =
    "open_vitals.activity-session-packet-derived-metric-plan-report.v1";
pub const ACTIVITY_SESSION_PACKET_DERIVED_METRIC_PLAN_GENERATED_BY: &str =
    "open-vitals-activity-session-packet-derived-metric-planner";
