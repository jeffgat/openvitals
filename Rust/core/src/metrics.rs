...
pub const OPENVITALS_HRV_V0_ID: &str = "open_vitals.hrv.v0";
pub const OPENVITALS_HRV_V0_VERSION: &str = "0.1.0";
pub const OPENVITALS_SLEEP_V0_ID: &str = "open_vitals.sleep.v0";
pub const OPENVITALS_SLEEP_V0_VERSION: &str = "0.1.0";
pub const OPENVITALS_SLEEP_V1_ID: &str = "open_vitals.sleep.v1";
pub const OPENVITALS_SLEEP_V1_VERSION: &str = "0.1.0";
pub const OPENVITALS_STRAIN_V0_ID: &str = "open_vitals.strain.v0";
pub const OPENVITALS_STRAIN_V0_VERSION: &str = "0.1.0";
pub const OPENVITALS_RECOVERY_V0_ID: &str = "open_vitals.recovery.v0";
pub const OPENVITALS_RECOVERY_V0_VERSION: &str = "0.1.0";
pub const OPENVITALS_STRESS_V0_ID: &str = "open_vitals.stress.v0";
pub const OPENVITALS_STRESS_V0_VERSION: &str = "0.1.0";
...
pub struct SleepModelStatusInput {
    ...
    #[serde(default)]
    pub trusted_open_vitals_sleep_nights: u32,
    #[serde(default)]
...
pub struct SleepModelStatusReport {
    ...
    #[serde(default)]
    pub nights_until_open_vitals_training: u32,
...
fn hrv_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        ...
        version: OPENVITALS_HRV_V0_VERSION.to_string(),
        metric_family: "hrv".to_string(),
        display_name: "OpenVitals HRV v0".to_string(),
        implementation: "rust".to_string(),
        license: "UNLICENSED".to_string(),
        input_schema: "open_vitals.hrv-input.v1".to_string(),
        output_schema: "open_vitals.hrv-output.v1".to_string(),
...
fn sleep_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        algorithm_id: OPENVITALS_SLEEP_V0_ID.to_string(),
        version: OPENVITALS_SLEEP_V0_VERSION.to_string(),
        metric_family: "sleep".to_string(),
        display_name: "OpenVitals Sleep v0".to_string(),
        implementation: "rust".to_string(),
        license: "UNLICENSED".to_string(),
        input_schema: "open_vitals.sleep-input.v1".to_string(),
        output_schema: "open_vitals.sleep-output.v1".to_string(),
        input_requirements_json: json!({
...
fn sleep_v1_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        algorithm_id: OPENVITALS_SLEEP_V1_ID.to_string(),
        version: OPENVITALS_SLEEP_V1_VERSION.to_string(),
        metric_family: "sleep".to_string(),
        display_name: "OpenVitals Sleep v1".to_string(),
        implementation: "rust".to_string(),
        license: "UNLICENSED".to_string(),
        input_schema: "open_vitals.sleep-v1-input.v1".to_string(),
        output_schema: "open_vitals.sleep-v1-output.v1".to_string(),
        input_requirements_json: json!({
        ...
        quality_gates_json: json!([
            ...
            "trained_requires_holdout_validation_and_open_vitals_packet_derived_nights"
        ])
        .to_string(),
        status: "experimental".to_string(),
    }
...
fn strain_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        ...
        display_name: "OpenVitals Strain v0".to_string(),
        implementation: "rust".to_string(),
        license: "UNLICENSED".to_string(),
        input_schema: "open_vitals.strain-input.v1".to_string(),
        output_schema: "open_vitals.strain-output.v1".to_string(),
        input_requirements_json: json!({
...
fn recovery_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        ...
        version: OPENVITALS_RECOVERY_V0_VERSION.to_string(),
...
fn stress_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        algorithm_id: OPENVITALS_STRESS_V0_ID.to_string(),
        version: OPENVITALS_STRESS_V0_VERSION.to_string(),
        metric_family: "stress".to_string(),
        display_name: "OpenVitals Stress v0".to_string(),
        implementation: "rust".to_string(),
        license: "UNLICENSED".to_string(),
        input_schema: "open_vitals.stress-input.v1".to_string(),
        output_schema: "open_vitals.stress-output.v1".to_string(),
        input_requirements_json: json!({
...
pub fn open_vitals_hrv_v0(input: &HrvInput) -> AlgorithmRunResult<HrvOutput> {
...
pub fn open_vitals_sleep_v0(input: &SleepInput) -> AlgorithmRunResult<SleepScoreOutput> {
    let mut quality_flags = Vec::new();
    let mut errors = Vec::new();
    ...
    let output = if errors.is_empty() {
        ...
        Some(SleepScoreOutput {
            algorithm_id: OPENVITALS_SLEEP_V0_ID.to_string(),
            algorithm_version: OPENVITALS_SLEEP_V0_VERSION.to_string(),
...
pub fn open_vitals_sleep_v1(input: &SleepV1Input) -> AlgorithmRunResult<SleepV1Output> {
    let mut quality_flags = Vec::new();
    let mut errors = Vec::new();
    ...
    let output = match (errors.is_empty(), v0_result.output) {
        (true, Some(v0_output)) => {
            ...
            Some(SleepV1Output {
                algorithm_id: OPENVITALS_SLEEP_V1_ID.to_string(),
                algorithm_version: OPENVITALS_SLEEP_V1_VERSION.to_string(),
...
pub fn evaluate_sleep_model_status(input: &SleepModelStatusInput) -> SleepModelStatusReport {
    ...
    if !input.sleep_permission_granted && valid_sleep_nights == 0 {
        ...
        next_actions.push(
            "Grant sleep history access or complete one OpenVitals packet-derived sleep night."
                .to_string(),
        );
        return sleep_model_status_report(
            SleepModelStatus::SetupNeeded,
            "Setup needed",
            "OpenVitals needs sleep history access or one packet-derived night to begin learning.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if input.history_import_in_progress && nights_until_baseline > 0 {
        ...
        return sleep_model_status_report(
            ...
            "Importing history",
            "OpenVitals is importing existing sleep history before building a baseline.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if input.timezone_or_schedule_shift_detected || input.repeated_low_confidence_nights {
        ...
        next_actions.push(
            "Collect several recent high-confidence nights so OpenVitals can refresh the baseline."
                .to_string(),
        );
        return sleep_model_status_report(
            SleepModelStatus::NeedsRelearn,
            "Needs relearn",
            "Recent sleep patterns differ enough that OpenVitals should refresh the personal model.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
        ...
        && valid_sleep_nights >= 7
    {
        ...
        return sleep_model_status_report(
            SleepModelStatus::NeedsRelearn,
            "Needs relearn",
            "The sleep baseline is stale because OpenVitals has not seen a recent valid night.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if input.holdout_validation_passed
        && input.trusted_open_vitals_sleep_nights >= 7
        ...
        && heart_rate_coverage_ok
    {
        return sleep_model_status_report(
            ...
            "Trained",
            "OpenVitals has a passed personal sleep model for this algorithm version.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if valid_sleep_nights == 0 {
        ...
        return sleep_model_status_report(
            SleepModelStatus::SetupNeeded,
            "Setup needed",
            "OpenVitals needs one valid sleep night to start learning.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if input.trusted_open_vitals_sleep_nights >= 7
        && input.calibration_label_count >= 14
        && !input.holdout_validation_passed
    {
        ...
        return sleep_model_status_report(
            ...
            "Training",
            "OpenVitals has enough sleep history for training, but holdout validation has not passed.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if input.trusted_open_vitals_sleep_nights == 0 {
        next_actions.push(
    ...
    sleep_model_status_report(
        ...
        "Baseline ready",
        "OpenVitals has enough sleep history for personal schedule and debt baselines.",
        input,
        valid_sleep_nights,
        nights_until_baseline,
        nights_until_training,
...
pub fn open_vitals_strain_v0(input: &StrainInput) -> AlgorithmRunResult<StrainScoreOutput> {
    let mut quality_flags = Vec::new();
    let mut errors = Vec::new();
...
pub fn open_vitals_stress_v0(input: &StressInput) -> AlgorithmRunResult<StressScoreOutput> {
    let mut quality_flags = Vec::new();
    let mut errors = Vec::new();
    ...
    let output = if errors.is_empty() {
        ...
        Some(StressScoreOutput {
            algorithm_id: OPENVITALS_STRESS_V0_ID.to_string(),
            algorithm_version: OPENVITALS_STRESS_V0_VERSION.to_string(),
            score_0_to_100: component_sum(&components),
...
pub fn algorithm_run_record<T: Serialize>(
...
) -> OpenVitalsResult<AlgorithmRunRecord> {
    let output_json = serde_json::to_string(&result.output).map_err(|error| {
        OpenVitalsError::message(format!("cannot serialize algorithm output: {error}"))
    })?;
    let quality_flags_json = serde_json::to_string(&result.quality_flags).map_err(|error| {
        OpenVitalsError::message(format!("cannot serialize algorithm quality flags: {error}"))
    })?;
    ...
    .map_err(|error| {
        OpenVitalsError::message(format!("cannot serialize algorithm provenance: {error}"))
    })?;
...
fn sleep_model_status_report(
    ...
    let can_show_final_score =
        can_show_personal_baseline && coverage_ready && input.trusted_open_vitals_sleep_nights > 0;
    ...
    SleepModelStatusReport {
        ...
        valid_sleep_nights,
        trusted_open_vitals_sleep_nights: input.trusted_open_vitals_sleep_nights,
