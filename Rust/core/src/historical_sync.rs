...
pub fn historical_sync_physical_evidence_template(
    ...
    HistoricalSyncPhysicalEvidenceTemplate {
        ...
        generated_by: "open-vitals-historical-sync-physical-validator".to_string(),
        generation,
...
fn finish_report(
    ...
    HistoricalSyncDryRunReport {
        ...
        generated_by: "open-vitals-historical-sync-dry-run".to_string(),
        generation: input.generation,
...
fn issue_action(issue: &str) -> String {
    match issue {
        "unsupported schema open_vitals.historical-sync-dry-run.v1" => {
...
fn physical_validation_issue_action(issue: &str) -> String {
    match issue {
        ...
        value if value.starts_with("unsupported schema ") => {
            "Use open_vitals.historical-sync-physical-validation.v1 for physical evidence bundles.".to_string()
        }
