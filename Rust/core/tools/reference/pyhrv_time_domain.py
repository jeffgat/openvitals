#!/usr/bin/env python3
"""pyHRV time-domain adapter for open-vitals-reference-algo-runner."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run pyHRV time-domain HRV for OpenVitals.")
...
def base_report(payload: dict[str, Any], provider_version: str) -> dict[str, Any]:
    return {
        ...
        "output_schema": "open_vitals.hrv-pyhrv-time-domain-output.v1",
