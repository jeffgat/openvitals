#!/usr/bin/env python3
"""GGIR sleep summary adapter for open-vitals-reference-algo-runner."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Summarize GGIR sleep output for OpenVitals benchmarks."
    )
...
def base_report(payload: dict[str, Any], provider_version_value: str) -> dict[str, Any]:
    return {
        ...
        "input_schema": "open_vitals.sleep-ggir-summary-input.v1",
        "output_schema": "open_vitals.sleep-ggir-summary-output.v1",
